...
const { dirname, resolve } = __webpack_require__(277);
const { readdirSync, statSync } = __webpack_require__(747);
...
const cssKeywords = __webpack_require__(710);
...
const ansiRegex = __webpack_require__(716);
...
const {Yargs, processArgv} = __webpack_require__(728);
...
const stringWidth = __webpack_require__(987);
const stripAnsi = __webpack_require__(236);
const wrap = __webpack_require__(957);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
const { argv } = __webpack_require__(258);
...
const route = __webpack_require__(639);
...
function applyExtends(config, cwd, mergeExtends, _shim) {
    ...
    if (Object.prototype.hasOwnProperty.call(config, 'extends')) {
        ...
        if (!isPath) {
            try {
                pathToDefault = /*require.resolve*/(__webpack_require__(167).resolve(config.extends));
            }
            catch (_err) {
                return config;
            }
        ...
        defaultConfig = isPath
            ...
            : __webpack_require__(167)(config.extends);
...
const { resolve } = __webpack_require__(277);
const y18n = __webpack_require__(707);
const Parser = __webpack_require__(88);
var cjsPlatformShim = {
    assert: {
        notStrictEqual: assert.notStrictEqual,
        strictEqual: assert.strictEqual,
    },
    cliui: __webpack_require__(290),
    findUp: __webpack_require__(5),
    getEnv: (key) => {
        return process.env[key];
    },
    getCallerFile: __webpack_require__(127),
    getProcessArgvBin: getProcessArgvBin,
    inspect,
    mainFilename: (_b = (_a = __webpack_require__(167) === null || __webpack_require__(167) === void 0 ? void 0 : __webpack_require__.c[__webpack_require__.s]) === null || _a === void 0 ? void 0 : _a.filename) !== null && _b !== void 0 ? _b : process.cwd(),
    Parser,
    ...
    readFileSync,
    require: __webpack_require__(167),
    requireDirectory: __webpack_require__(822),
    stringWidth: __webpack_require__(987),
    y18n: y18n({
...
const Parser$1 = __webpack_require__(88);
...
var fs = __webpack_require__(747),
  join = __webpack_require__(277).join,
  resolve = __webpack_require__(277).resolve,
  dirname = __webpack_require__(277).dirname,
  defaultOptions = {
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __webpack_require__(535);
	}
...
const stripAnsi = __webpack_require__(236);
const isFullwidthCodePoint = __webpack_require__(186);
const emojiRegex = __webpack_require__(313);
